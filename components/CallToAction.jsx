        ...
        <section className="flex justify-center px-4 py-20">
            <div className="relative bg-gradient-to-br from-blue-950 via-blue-800 to-blue-700 text-white p-12 rounded-3xl max-w-[1080px] w-full shadow-xl">
                ...
                <div className="flex flex-col md:flex-row gap-6 justify-center">
                    <Link
                        href="/apply"
                        className="bg-blue-300 text-blue-950 font-semibold px-8 py-4 rounded-xl shadow-md hover:bg-blue-400 transition duration-300"
                    >
                        Apply Online
                    </Link>
                    <Link
                        href="/instructor"
                        className="bg-blue-900 text-white font-semibold px-8 py-4 rounded-xl shadow-md hover:bg-blue-800 transition duration-300"
                    >
